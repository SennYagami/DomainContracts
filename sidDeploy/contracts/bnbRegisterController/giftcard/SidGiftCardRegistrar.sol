...
import "../interface/ISidGiftCardRegistrar.sol";
import "../utils/Strings.sol";
import "../security/Pausable.sol";

contract SidGiftCardRegistrar is
    ERC1155,
    ISidGiftCardRegistrar,
    Ownable,
    Pausable
{
    ...
    {
        return
            string(abi.encodePacked(ERC1155.uri(_id), Strings.toString(_id)));
    }
    ...
    function safeBatchTransferFrom(
        ...
        bytes memory data
    ) public virtual override(ERC1155, IERC1155) whenNotPaused {
        require(
            ids.length == amounts.length,
            "ERC1155: ids and amounts length mismatch"
        );
