...
contract SidGiftCardVoucher is Ownable {
    ...
    function addCustomizedVoucher(uint256 tokenId, uint256 price)
        external
        onlyOwner
    {
    ...
    function totalValue(uint256[] calldata ids, uint256[] calldata amounts)
        external
        view
        returns (uint256)
    {
    ...
    function isValidVoucherIds(uint256[] calldata id)
        external
        view
        returns (bool)
    {
