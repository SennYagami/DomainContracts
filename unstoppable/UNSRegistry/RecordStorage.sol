...
import "./interface/IRecordStorage.sol";
...
abstract contract RecordStorage is KeyStorage, IRecordStorage {
    ...
    function _presetOf(uint256 tokenId)
        internal
        view
        virtual
        returns (uint256)
    ...
    function _get(string memory key, uint256 tokenId)
        private
        view
    ...
    function _get(uint256 keyHash, uint256 tokenId)
        private
        view
        returns (string memory)
    {
