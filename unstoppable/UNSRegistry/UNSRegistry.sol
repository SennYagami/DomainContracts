    ...
    IUNSRegistry
{
    ...
    function initialize(
        ...
        StorageSlotUpgradeable
            .getAddressSlot(_CNS_REGISTRY_SLOT)
            .value = cnsRegistry;
    ...
    function namehash(string[] calldata labels)
        external
        pure
        override
        returns (uint256)
    ...
    function exists(uint256 tokenId)
        external
        view
        override(IUNSRegistry, IMintableERC721)
        returns (bool)
    {
    ...
    function mintTLD(uint256 tokenId, string calldata uri)
        external
        override
        onlyMintingManager
    {
    ...
    bytes32 internal constant _CNS_REGISTRY_SLOT =
        0x8ffb960699dc2ba88f34d0e41c029c3c36c95149679fe1d0153a9582bec92378;
    ...
    function onERC721Received(
        ...
        if (
            _msgSender() ==
            StorageSlotUpgradeable.getAddressSlot(_CNS_REGISTRY_SLOT).value
        ) {
     ...
     */
    function depositToPolygon(uint256 tokenId)
        external
        override
        onlyApprovedOrOwner(tokenId)
    {
     ...
     */
    function setReverse(uint256 tokenId)
        external
        override
        onlyOwner(tokenId)
        protectTokenOperation(tokenId)
     ...
     */
    function reverseOf(address addr)
        external
        view
        override
        returns (uint256 reverse)
    {
    ...
    function reverseNameOf(address addr)
        external
        view
        override
        returns (string memory reverseUri)
    {
        uint256 tokenId = _reverses[addr];
        if (!_isReadRestricted(tokenId)) {
     ...
     */
    function backfillReverseNames(string[][] memory domains)
        external
        override
        onlyMintingManager
    {
    ...
    function _namehash(uint256 tokenId, string memory label)
        internal
        pure
        returns (uint256)
    {
    ...
    function _msgSender()
        internal
        view
        override(ContextUpgradeable, ERC2771RegistryContext)
        returns (address)
    {
    ...
    function _beforeTokenTransfer(
        ...
        require(
            !_upgradedTokens[tokenId] || to != address(0),
    ...
    function _isReadRestricted(uint256 tokenId)
        internal
        view
        override
        returns (bool)
